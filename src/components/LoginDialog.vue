...
<template>
  <v-dialog transition="dialog-top-transition" width="auto" min-width="400" max-width="100%">
        ...
        <v-form v-model="formValid">
          ...
          >
            <template #append-inner>
              <v-btn flat size="small" icon @click="passwordVisible = !passwordVisible">
                <v-icon :icon="passwordVisible ? 'mdi-eye-off-outline' : 'mdi-eye-outline'" />
              </v-btn>
            </template>
          </v-text-field>
        </v-form>
